    ...
    predictBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                currentPriceElement.textContent = `Current Price: ${currencySymbol}${data.current_price}`;
                predictedPriceElement.textContent = `Predicted Price: ${currencySymbol}${data.predicted_price}`;
                
                // Update explanation
                explanationElement.innerHTML = generateExplanationHTML(data);
                document.getElementById('buyPrice').textContent = `Buy Price: ${currencySymbol}${data.buy_price}`;
                document.getElementById('sellPrice').textContent = `Sell Price: ${currencySymbol}${data.sell_price}`;
                ...
                const tradingViewSymbol = market === 'nse' ? `NSE:${symbol}` : symbol;
